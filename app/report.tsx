...
type TargetType = 'business' | 'review' | 'review_comment' | 'response' | 'update' | 'media' | 'user';
  ...
  const validTarget = useMemo(
    () =>
      Boolean(
        params.targetId &&
          params.targetType &&
          ['business', 'review', 'review_comment', 'response', 'update', 'media', 'user'].includes(params.targetType)
      ),
